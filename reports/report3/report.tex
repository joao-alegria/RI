...
0.25 respectively.
The final precision for each \texttt{n} was: ..........................
At last we inverted the parameters variation in order to study the effects of 
alpha, beta and gamma.
To do this, we fixed \texttt{n} at ......... and tested the 3 parameters with
the following combinations: ................
These values were chosen based on recommendations from studies on the Rocchio
algorithm and the ones with the best precision were \texttt{a = }, 
\texttt{b = } and \texttt{g = }, with a final percentage of .......... \%.
...
a cheap verification is done to determine wether it is worth executing them, so
...
The key aspect here is the condition that determines wether de calculation must 
