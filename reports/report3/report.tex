...
positive impact on the overal performance of the ranked retrieval, but it is 
also logical that the first form will update the document scores in a way that
increases more the precision than the pseudo feedback. 
...
The later reached a precision of 26\%, with a query throughput of ..............
...
and ........... precision gain .....................
With the user feedback, on the other hand, although taking even longer to answer
each query, proved to have great value when tested.
To test these forms of feedback, we varied the parameters \texttt{n} (number of 
...
0.25 respectively.
The final precision for each \texttt{n} was .....\%, .....\% and .....\% for pseudo, and
28\%, 29\% and 29\% for the user feedback.
...
between 0 and 1, but this time only to the user feedback as it showed the best 
potential to achieve higher precision percentages.
